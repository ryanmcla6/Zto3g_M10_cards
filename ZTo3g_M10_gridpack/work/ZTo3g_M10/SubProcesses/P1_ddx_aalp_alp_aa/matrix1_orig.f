...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL VVS2_3(W(1,4),W(1,5),GC_56,MDL_MALP, FK_MDL_WALP,W(1,6))
      CALL FFV2_3_3(W(1,1),W(1,2),GC_91,GC_102,MDL_MZ, FK_MDL_WZ,W(1,5)
     $ )
C     Amplitude(s) for diagram number 1
      CALL VVS2_0(W(1,3),W(1,5),W(1,6),GC_110,AMP(1))
