...
C     
C     Process: d d~ > z > a alp WEIGHTED<=4 @1
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),MDL_MD,+1,+1*IC(1),W(1,1))  !  count 2
      CALL IXXXXX(P(0,1),MDL_MD,-1,+1*IC(1),W(1,2))  !  count 2
      CALL OXXXXX(P(0,2),MDL_MD,+1,-1*IC(2),W(1,3))  !  count 2
      CALL OXXXXX(P(0,2),MDL_MD,-1,-1*IC(2),W(1,4))  !  count 2
