...
C     
C     Process: u u~ > z > a alp WEIGHTED<=4 @1
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),MDL_MU,+1,+1*IC(1),W(1,1))  !  count 1
      CALL IXXXXX(P(0,1),MDL_MU,-1,+1*IC(1),W(1,2))  !  count 1
      CALL OXXXXX(P(0,2),MDL_MU,+1,-1*IC(2),W(1,3))  !  count 1
      CALL OXXXXX(P(0,2),MDL_MU,-1,-1*IC(2),W(1,4))  !  count 1
      CALL VXXXXX(P(0,3),ZERO,+1,+1*IC(3),W(1,5))  !  count 4
      CALL VXXXXX(P(0,3),ZERO,-1,+1*IC(3),W(1,6))  !  count 4
      ...
      CALL VVS2_3(W(1,7),W(1,9),GC_56,MDL_MALP,FK_MDL_WALP,W(1,11))  !  count 4
      CALL VVS2_3(W(1,8),W(1,10),GC_56,MDL_MALP,FK_MDL_WALP,W(1,12))  !  count 4
      CALL FFV2_5_3(W(1,1),W(1,4),GC_92,GC_102,MDL_MZ,FK_MDL_WZ,W(1,13))
     $  !  count 4
      CALL FFV2_5_3(W(1,2),W(1,3),GC_92,GC_102,MDL_MZ,FK_MDL_WZ,W(1,14))
     $  !  count 4
      CALL VVS2P1N_1(W(1,13), W(1,11), GC_110, TMP(1))
      call CombineAmp(2,
     & (/4,2/), 
     & (/5,6/),
     & TMP, W, AMP(1,1))
      CALL VVS2P1N_1(W(1,13), W(1,12), GC_110, TMP(1))
      call CombineAmp(2,
     & (/3,1/), 
     & (/5,6/),
     & TMP, W, AMP(1,1))
      CALL VVS2P1N_1(W(1,14), W(1,11), GC_110, TMP(1))
      call CombineAmp(2,
     & (/8,6/), 
     & (/5,6/),
     & TMP, W, AMP(1,1))
      CALL VVS2P1N_1(W(1,14), W(1,12), GC_110, TMP(1))
      call CombineAmp(2,
     & (/7,5/), 
     & (/5,6/),
