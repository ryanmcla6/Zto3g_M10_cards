...
C     
C     Process: s s~ > z > a alp WEIGHTED<=4 @1
C     *   Decay: alp > a a WEIGHTED<=2
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
        IF(mdl_WALP.ne.0d0) fk_mdl_WALP = SIGN(MAX(ABS(mdl_WALP),
     $    ABS(mdl_MALP*small_width_treatment)), mdl_WALP)
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),MDL_MS,+1,+1*IC(1),W(1,1))  !  count 2
      CALL IXXXXX(P(0,1),MDL_MS,-1,+1*IC(1),W(1,2))  !  count 2
      CALL OXXXXX(P(0,2),MDL_MS,+1,-1*IC(2),W(1,3))  !  count 2
      CALL OXXXXX(P(0,2),MDL_MS,-1,-1*IC(2),W(1,4))  !  count 2
      CALL VXXXXX(P(0,3),ZERO,+1,+1*IC(3),W(1,5))  !  count 8
      CALL VXXXXX(P(0,3),ZERO,-1,+1*IC(3),W(1,6))  !  count 8
      CALL VXXXXX(P(0,4),ZERO,+1,+1*IC(4),W(1,7))  !  count 1
      CALL VXXXXX(P(0,4),ZERO,-1,+1*IC(4),W(1,8))  !  count 1
      CALL VXXXXX(P(0,5),ZERO,+1,+1*IC(5),W(1,9))  !  count 1
      CALL VXXXXX(P(0,5),ZERO,-1,+1*IC(5),W(1,10))  !  count 1
      CALL VVS2_3(W(1,7),W(1,9),GC_56,MDL_MALP,FK_MDL_WALP,W(1,11))  !  count 8
      CALL VVS2_3(W(1,8),W(1,10),GC_56,MDL_MALP,FK_MDL_WALP,W(1,12))  !  count 8
      CALL FFV2_3_3(W(1,1),W(1,3),GC_91,GC_102,MDL_MZ,FK_MDL_WZ,W(1,13))
     $  !  count 4
      CALL FFV2_3_3(W(1,1),W(1,4),GC_91,GC_102,MDL_MZ,FK_MDL_WZ,W(1,14))
     $  !  count 4
      CALL FFV2_3_3(W(1,2),W(1,3),GC_91,GC_102,MDL_MZ,FK_MDL_WZ,W(1,15))
     $  !  count 4
      CALL FFV2_3_3(W(1,2),W(1,4),GC_91,GC_102,MDL_MZ,FK_MDL_WZ,W(1,16))
     $  !  count 4
      CALL VVS2P1N_2(W(1,5), W(1,11), GC_110, TMP(1))
      call CombineAmp(4,
     & (/8,4,16,12/), 
     & (/13,14,15,16/),
     & TMP, W, AMP(1,1))
      CALL VVS2P1N_2(W(1,5), W(1,12), GC_110, TMP(1))
      call CombineAmp(4,
     & (/7,3,15,11/), 
     & (/13,14,15,16/),
     & TMP, W, AMP(1,1))
      CALL VVS2P1N_2(W(1,6), W(1,11), GC_110, TMP(1))
      call CombineAmp(4,
     & (/6,2,14,10/), 
     & (/13,14,15,16/),
     & TMP, W, AMP(1,1))
      CALL VVS2P1N_2(W(1,6), W(1,12), GC_110, TMP(1))
      call CombineAmp(4,
     & (/5,1,13,9/), 
     & (/13,14,15,16/),
