...
C     
C     Process: c c~ > z > a alp WEIGHTED<=4 @1
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),MDL_MC,+1,+1*IC(1),W(1,1))  !  count 2
      CALL IXXXXX(P(0,1),MDL_MC,-1,+1*IC(1),W(1,2))  !  count 2
      CALL OXXXXX(P(0,2),MDL_MC,+1,-1*IC(2),W(1,3))  !  count 2
      CALL OXXXXX(P(0,2),MDL_MC,-1,-1*IC(2),W(1,4))  !  count 2
      ...
      CALL FFV2_5_3(W(1,1),W(1,3),GC_92,GC_102,MDL_MZ,FK_MDL_WZ,W(1,13))
     $  !  count 4
      CALL FFV2_5_3(W(1,1),W(1,4),GC_92,GC_102,MDL_MZ,FK_MDL_WZ,W(1,14))
     $  !  count 4
      CALL FFV2_5_3(W(1,2),W(1,3),GC_92,GC_102,MDL_MZ,FK_MDL_WZ,W(1,15))
     $  !  count 4
      CALL FFV2_5_3(W(1,2),W(1,4),GC_92,GC_102,MDL_MZ,FK_MDL_WZ,W(1,16))
     $  !  count 4
