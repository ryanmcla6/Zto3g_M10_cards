...
C     
      ...
      P3(2) = -DIMAG(S3(2))
      P3(3) = -DIMAG(S3(1))
      TMP0 = (-1D0)*(P1(0)*(P2(1)*(-V2(6)*V1(5)+V2(5)*V1(6))+(P2(2)
     ...
     $ -V2(3)*V1(4)))))))
      TMP1 = (-1D0)*(P1(0)*(P2(1)*(V2(6)*V1(5)-V2(5)*V1(6))+(P2(2)*(
     $ -V2(6)*V1(4)+V2(4)*V1(6))+P2(3)*(V2(5)*V1(4)-V2(4)*V1(5))))
     $ +(P1(1)*(P2(0)*(-V2(6)*V1(5)+V2(5)*V1(6))+(P2(2)*(V2(6)*V1(3)
     $ -V2(3)*V1(6))+P2(3)*(-V2(5)*V1(3)+V2(3)*V1(5))))+(P1(2)*(P2(0)
     $ *(V2(6)*V1(4)-V2(4)*V1(6))+(P2(1)*(-V2(6)*V1(3)+V2(3)*V1(6))
     $ +P2(3)*(V2(4)*V1(3)-V2(3)*V1(4))))+P1(3)*(P2(0)*(-V2(5)*V1(4)
     $ +V2(4)*V1(5))+(P2(1)*(V2(5)*V1(3)-V2(3)*V1(5))+P2(2)*(-V2(4)
     $ *V1(3)+V2(3)*V1(4)))))))
      DENOM = COUP/(P3(0)**2-P3(1)**2-P3(2)**2-P3(3)**2 - M3 * (M3 -CI
     $ * W3))
      S3(3)= DENOM*(-CI*(TMP0)+CI*(TMP1))
      END
