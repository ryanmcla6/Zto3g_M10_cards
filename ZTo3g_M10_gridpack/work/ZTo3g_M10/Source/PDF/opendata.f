...
C     First try system wide (for cluster if define)
      ...
      TEMPNAME='/cvmfs/cms.cern.ch/el9_amd64_gcc11/external/lhapdf'
     $ //'/6.4.0-a1eec6e5fc67bd79ff44968065caf8fe/share/LHAPDF'/
     $ /TABLEFILE
      OPEN(IU,FILE=TEMPNAME,STATUS='old',ERR=1)
      RETURN
 1    TEMPNAME='/cvmfs/cms.cern.ch/el9_amd64_gcc11/external/lhapdf'
     $ //'/6.4.0-a1eec6e5fc67bd79ff44968065caf8fe/share/LHAPDF/Pdfdata'
     $ //'/'//TABLEFILE
      OPEN(IU,FILE=TEMPNAME,STATUS='old',ERR=2)
      RETURN
 2    TEMPNAME='/cvmfs/cms.cern.ch/el9_amd64_gcc11/external/lhapdf'
     $ //'/6.4.0-a1eec6e5fc67bd79ff44968065caf8fe/share/LHAPDF/lhapdf'
     $ //TABLEFILE
      OPEN(IU,FILE=TEMPNAME,STATUS='old',ERR=3)
      RETURN
 3    TEMPNAME='/cvmfs/cms.cern.ch/el9_amd64_gcc11/external/lhapdf'
     $ //'/6.4.0-a1eec6e5fc67bd79ff44968065caf8fe/share/LHAPDF/..'
     $ //'/lhapdf/pdfsets/'//TABLEFILE
      OPEN(IU,FILE=TEMPNAME,STATUS='old',ERR=4)
      RETURN
 4    TEMPNAME='/cvmfs/cms.cern.ch/el9_amd64_gcc11/external/lhapdf'
     $ //'/6.4.0-a1eec6e5fc67bd79ff44968065caf8fe/share/LHAPDF/..'
